...
def test_pauli_frame_flip_rules_single_qubit() -> None:
...
def test_correct_output_bitstring_for_deferred_frame_single_qubit() -> None:
...
def test_corrected_counts_from_deferred_shots_two_qubit_mixed_basis() -> None:
